...
注意例2的写法使用了**URL标识符**的形式，在[链接](#_11)一节有介绍。
>在文末有code-past的定义：
```
...
定义元素的语法 `tag[content]--> tag[content]`。
...
![Star History Chart](https://api.star-history.com/svg?repos=guodongxiaren/README&type=Date)
...
| 原作者      | 果冻虾仁                            |
|-------------|-------------------------------------|
| Github 文档 | https://github.com/younghz/Markdown |
| 公众号      | 编程往事                            |

****

原作者的博客: [http://blog.csdn.net/guodongxiaren](http://blog.csdn.net/guodongxiaren)

原作者的知乎: [https://www.zhihu.com/people/guodongxiaren](https://www.zhihu.com/people/guodongxiaren)

原作者的微博: [http://weibo.com/linpiaochen](http://weibo.com/linpiaochen)
